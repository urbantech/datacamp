"""Product schema definitions using Pydantic."""
...
class ProductSchema(BaseModel):
    ...
    images: List[HttpUrl] = Field(..., min_length=1, description="Product images")
    ...
    # Optional fields
    sku: Optional[str] = Field(None, pattern=r"^[A-Za-z0-9-]+$", description="SKU")
    ...
    variants: List[str] = Field(
        default_factory=list, description="List of product variants"
    )
