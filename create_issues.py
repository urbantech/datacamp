"""Script to create GitHub issues for the BoomScraper project.

This script uses the GitHub API to create issues for features, bugs, and chores.
...
milestone = repo.create_milestone(
    "BoomScraper Sprint 1",
    state="open",
    description="First sprint for BoomScraper project",
)
